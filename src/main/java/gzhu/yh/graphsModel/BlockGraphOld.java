 ...
 **/
@Getter
public class BlockGraphOld extends Graph {
    ...
    public BlockGraphOld(Integer v, Integer e, List<List<Integer>> adjMatrix, List<Pair<Integer, Integer>> edges) {
        super(v, e, adjMatrix, edges);
        setGraphType();
    }
    public BlockGraphOld(Integer v, Integer e, List<List<Integer>> adjMatrix, List<List<Integer>> adjList, List<Pair<Integer, Integer>> edges) {
        super(v, e, adjMatrix, edges);
     ...
     */
    public static BlockGraphOld randomGenBlockGraphByVertexNum(Integer vertexNum) {
...
//            int blockSize = weightedRandom(1, remainingVertices + 1);
        ...
        BlockGraphOld blockGraph = new BlockGraphOld(vertexNum, edges.size(), adjMatrix,adjList, edges);
